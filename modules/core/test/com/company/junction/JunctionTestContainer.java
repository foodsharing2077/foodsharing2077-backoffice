...
public class JunctionTestContainer extends TestContainer {

    public JunctionTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/junction/app.properties",
    ...
    public static class Common extends JunctionTestContainer {

        public static final JunctionTestContainer.Common INSTANCE = new JunctionTestContainer.Common();
